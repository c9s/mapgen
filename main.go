	...
	for _, file := range g.pkg.Syntax {
		ast.Inspect(file, func(n ast.Node) bool {
			...
			for _, spec := range decl.Specs {
				...
				log.Debugf("valueSpec.Names: %+v, type: %+v, typeAndValue: %+v", valueSpec.Names, valueSpec.Type, typeAndValue.Type.Underlying())

				// Set typeAndValue once using parseConstantTypeAndValue
				if !typeSet {
